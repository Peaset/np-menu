...
newSubMenus = {
    ...
    ['kiyafet1'] = {
        title = "Şapkanı Çıkar",
        icon = "#expressions",
        functionName = "kiyafet1"
    },	
    ['kiyafet2'] = {
        title = "Maskeni Çıkart",
        icon = "#expressions",
        functionName = "kiyafet2"
    },
    ['kiyafet3'] = {
        title = "Eldivenini Çıkart",
        icon = "#expressions",
        functionName = "kiyafet3"
    },
    ['blips:gasstations'] = {
   ...
   --[[ ['blips:trainstations'] = {
    ...
    ['attach:ex_office_swag_guns03'] = { 
        title = "Silahları Uzat",
        icon = "#general-unseat-nearest",
        functionName = "attach:ex_office_swag_guns03"
    },
	['attach:p_gcase_s'] = { 
        title = "Silah Ekstralarını Al",
        icon = "#general-unseat-nearest",
        functionName = "attach:p_gcase_s"
    },
    ['police:impound'] = {
        title = "Aracı Çek",
        icon = "#police-vehicle",
